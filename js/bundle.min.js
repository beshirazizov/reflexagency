...
const pointer=document.createElement("div");pointer.id="pointer-dot";const ring=document.createElement("div");ring.id="pointer-ring",document.body.insertBefore(pointer,document.body.children[0]),document.body.insertBefore(ring,document.body.children[0]);let mouseX=-100,mouseY=-100,ringX=-100,ringY=-100,mouseDown=!1;const init_pointer=()=>{window.onmousemove=(n=>{mouseX=n.clientX,mouseY=n.clientY}),window.onmousedown=(()=>{mouseDown=!0}),window.onmouseup=(()=>{mouseDown=!1}),$("a, button").hover(function(){mouseDown=!0},function(){mouseDown=!1});const n=(n,o,e)=>(1-e)*n+e*o;window.trace=n;const o=()=>{ringX=n(ringX,mouseX,.1),ringY=n(ringY,mouseY,.1),ring.style.padding="25px",mouseDown?$(ring).css("border-color","#105fef"):$(ring).css("border-color","#aaaaaa"),pointer.style.transform=`translate(${mouseX}px, ${mouseY}px)`,ring.style.transform=`translate(${ringX-24.1}px, ${ringY-24.1}px)`,requestAnimationFrame(o)};requestAnimationFrame(o)};
